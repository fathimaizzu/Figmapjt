...
function Card() {
  return (
   ...
   <img src="./assets/rectangle.png" alt="card" className='w-full' />
  ...
  <h1 className='font-bold text-[19.2] pt-[20px]'> Raja Ampat, Papua Barat </h1>
   ...
   <div className='flex gap-2'>
    ...
    <div className=' shadow-xl drop-shadow-2xl rounded-xl  p-[10px]' >
      <img src="./assets/card5.png" alt="card" className='w-full' /> 
   ...
   <div className='flex gap-2'>
    ...
    <p>12 days for trips</p>
        ...
        <div className=' shadow-xl drop-shadow-2xl rounded-xl  p-[10px] ' >
      <img src="./assets/GroupA.png" alt="card" className='w-full' /> 
   ...
   <div className='flex gap-2'>
    ...
    <p>7 days for trips</p>
        ...
        <div className='  shadow-xl drop-shadow-2xl rounded-xl  p-[10px]' >
   <img src="./assets/Group14.png" alt="card" className='w-full' />
